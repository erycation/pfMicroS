...
@Component({
  selector: 'app-losing-images',
  templateUrl: './losing-images.component.html',
  styleUrls: ['./losing-images.component.css']
})
export class LosingImagesComponent implements OnInit {
